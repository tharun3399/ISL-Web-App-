      ...
      <div className="w-full max-w-sm z-10 space-y-6 animate-in fade-in zoom-in-95 duration-700">
        ...
        <div className="bg-[#080808] p-6 md:p-8 rounded-[2rem] border border-zinc-900 space-y-6 shadow-2xl relative">
          ...
          <button 
            ...
            className="w-full py-2.5 bg-zinc-900/20 border border-zinc-800 text-white font-bold rounded-lg flex items-center justify-center gap-3 hover:bg-zinc-900/40 transition-all active:scale-[0.98]"
          >
