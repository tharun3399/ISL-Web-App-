  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-zinc-900 pb-8">
        <div>
          <h2 className="text-xs font-black text-zinc-500 uppercase tracking-[0.4em] mb-2">Core System Architecture</h2>
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <div className="bg-[#080808] border border-zinc-900 rounded-[2.5rem] p-8">
            <div className="flex justify-between items-start mb-10">
              <div>
                <h3 className="text-xl font-black tracking-tighter text-white uppercase">Weekly Activity</h3>
                <p className="text-xs text-zinc-600 font-bold uppercase tracking-widest mt-1">Focus Minutes</p>
              </div>
              <div className="px-3 py-1.5 bg-zinc-900/50 border border-zinc-800 rounded-lg text-[10px] font-black text-zinc-400 uppercase tracking-widest">7 Day History</div>
            </div>
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <div className="bg-zinc-900/10 border border-zinc-900/50 rounded-[2rem] p-6 relative overflow-hidden group hover:border-zinc-700 transition-colors">
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                <p className="font-black text-white text-xs uppercase tracking-tight">Silent Speaker</p>
                <p className="text-[10px] text-zinc-600 font-bold uppercase tracking-widest mt-0.5">2/5 modules complete</p>
              </div>
            </div>
          </div>
        </div>
